...
srun -n 1 --exact python train.py --outdir=./training_results/ --gpus=4 --batch=64 --metrics=fid2993_full --data=/project/home/p200493/KidsMiccaiDataset/croplip_mask/imgs/ --dataloader=datasets.dataset_256.ImageFolderMaskDataset --workers=3 --mirror=True --cond=False --cfg=places256 --aug=ada --generator=networks.mat.Generator --discriminator=networks.mat.Discriminator --loss=losses.loss.TwoStageLoss --pr=0.1 --pl=False --truncation=0.5 --style_mix=0.5 --ema=10 --lr=0.001 > stylegan_new.out
