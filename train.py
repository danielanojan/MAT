...
def setup_training_loop_kwargs(
    ...
    args.training_set_kwargs = dnnlib.EasyDict(class_name=dataloader, path=data, use_mask=use_mask, mask_path=mask,
                                               use_labels=True, max_size=None, xflip=False)
    args.val_set_kwargs = dnnlib.EasyDict(class_name=dataloader, path=data_val, use_mask=use_mask, mask_path=mask_val,
                                          use_labels=True, max_size=None, xflip=False)
    ...
    try:
        ...
        print ("--------------------------------VAL DATA--------------------------"+str(args.val_set_kwargs.max_size))
...
@click.option('--mask', help='location of the mask data directory. Only needed if use_mask=True', default='/clown', metavar='DIR')
@click.option('--mask_val', help='Location of the validation mask directory. Only needed if use_mask=True', metavar='DIR')
